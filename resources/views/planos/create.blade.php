<!-- filepath: resources/views/planos/create.blade.php -->
@extends('layouts.app')

@section('content')
<div class="planos-container">
    <div class="planos-header">
        <h1 class="planos-title">Crear Nuevo Plano</h1>
        ...
        <form action="{{ route('planos.store') }}" method="POST">
            ...
            <div class="plano-form-section">
                ...
                <div class="plano-form-row">
                    <div class="plano-form-group">
                        ...
                        <input type="text" id="codigo" name="codigo" class="plano-form-input" required>
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="ref_np" class="plano-form-label">Referencia</label>
                        <input type="text" id="ref_np" name="ref_np" class="plano-form-input">
                    </div>
                </div>
                ...
                <div class="plano-form-row">
                    <div class="plano-form-group full-width">
                        ...
                        <input type="text" id="descripcion" name="descripcion" class="plano-form-input" required>
                    </div>
                </div>
                ...
                <div class="plano-form-row">
                    <div class="plano-form-group">
                        ...
                        <input type="text" id="tipo_plano" name="tipo_plano" class="plano-form-input">
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="vercion" class="plano-form-label">Versión</label>
                        <input type="text" id="vercion" name="vercion" class="plano-form-input">
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="rev" class="plano-form-label">Revisión</label>
                        <input type="text" id="rev" name="rev" class="plano-form-input">
                    </div>
                </div>
                ...
                <div class="plano-form-row">
                    <div class="plano-form-group">
                        ...
                        <input type="number" id="orden" name="orden" class="plano-form-input" value="0">
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="id_unidad" class="plano-form-label">ID Unidad</label>
                        <input type="text" id="id_unidad" name="id_unidad" class="plano-form-input">
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="id_conjunto" class="plano-form-label">ID Conjunto</label>
                        <input type="text" id="id_conjunto" name="id_conjunto" class="plano-form-input">
                    </div>
                </div>
            </div>
            ...
            <div class="plano-form-section">
                ...
                <div class="plano-form-row">
                    <div class="plano-form-group">
                        ...
                        <input type="text" id="nombre_plano" name="nombre_plano" class="plano-form-input">
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="ext" class="plano-form-label">Extensión</label>
                        <input type="text" id="ext" name="ext" class="plano-form-input">
                    </div>
                </div>
                ...
                <div class="plano-form-row">
                    <div class="plano-form-group">
                        ...
                        <input type="text" id="nombre_dwg" name="nombre_dwg" class="plano-form-input">
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="ext_dwg" class="plano-form-label">Extensión DWG</label>
                        <input type="text" id="ext_dwg" name="ext_dwg" class="plano-form-input">
                    </div>
                </div>
                
                <div class="plano-form-row">
                    <div class="plano-form-group">
                        <label for="nombre_pdf" class="plano-form-label">Nombre del Archivo PDF</label>
                        <input type="text" id="nombre_pdf" name="nombre_pdf" class="plano-form-input">
                    </div>
                    
                    <div class="plano-form-group">
                        <label for="ruta" class="plano-form-label">Ruta del Archivo</label>
                        <input type="text" id="ruta" name="ruta" class="plano-form-input">
                    </div>
                </div>
            </div>
            ...
            <div class="plano-form-section">
                ...
                <div class="plano-form-row">
                    <div class="plano-form-group full-width">
                        ...
                        <textarea id="comentario" name="comentario" class="plano-form-textarea" rows="3"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="plano-form-section">
                ...
                <div class="plano-form-row">
                    ...
                    <div class="plano-form-group checkbox-group">
                        <label class="plano-checkbox-container">
                            <input type="checkbox" name="valido" value="1" checked>
                    ...
                    <div class="plano-form-group checkbox-group">
                        <label class="plano-checkbox-container">
                            ...
                            <span class="plano-checkbox-label">Digital</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="plano-form-footer">
                <a href="{{ route('planos.index') }}" class="planos-btn-secondary">Cancelar</a>
                <button type="submit" class="planos-btn">Crear Plano</button>
            </div>
        </form>
    </div>
</div>
